...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { contenido: @comentario.contenido, fecha: @comentario.fecha, hora: @comentario.hora, plato_id: @comentario.plato_id, puntaje: @comentario.puntaje, restaurante_id: @comentario.restaurante_id, user_id: @comentario.user_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { contenido: @comentario.contenido, fecha: @comentario.fecha, hora: @comentario.hora, plato_id: @comentario.plato_id, puntaje: @comentario.puntaje, restaurante_id: @comentario.restaurante_id, user_id: @comentario.user_id } }
