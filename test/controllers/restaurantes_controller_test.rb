...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { correo: @restaurante.correo, direccion: @restaurante.direccion, imagen: @restaurante.imagen, nombre: @restaurante.nombre, telefono: @restaurante.telefono, valoracion: @restaurante.valoracion } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { correo: @restaurante.correo, direccion: @restaurante.direccion, imagen: @restaurante.imagen, nombre: @restaurante.nombre, telefono: @restaurante.telefono, valoracion: @restaurante.valoracion } }
